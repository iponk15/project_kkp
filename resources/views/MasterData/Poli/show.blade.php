...
@section('content')
        ...
        <form class="form" id="poliFormTambah" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="poli_nama" placeholder="Masukan nama ..." autocomplete="off"/>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <textarea name="poli_deskripsi" class="form-control" rows="3" placeholder="Masukan deskripsi ..."></textarea>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var fields = {
                poli_nama      : { validators : { notEmpty : { message : 'Nama tidak boleh kosong' } } },
                poli_deskripsi : { validators : { notEmpty : { message : 'De tidak boleh kosong' } } },
            };
