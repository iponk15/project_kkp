...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="roleFormEdit" method="POST" data-cofirm="1">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="role_nama" placeholder="Masukan sekolah / universitas ..." autocomplete="off" value="{{ $records->role_nama }}" />
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="role_kode" placeholder="Masukan kode ..." autocomplete="off" value="{{ $records->role_kode }}" />
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="role_deskripsi" placeholder="Masukan deskripsi ..." autocomplete="off" value="{{ $records->role_deskripsi }}"/>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('roleFormEdit');
            var urll   = "{{ route($route . '.update', ['id' => $id]) }}";
            var fields = {
                role_nama      : { validators : { notEmpty : { message : 'Nama tidak boleh kosong' } } },
                role_kode      : { validators : { notEmpty : { message : 'Kode tidak boleh kosong' } } },
                role_deskripsi : { validators : { notEmpty : { message : 'De tidak boleh kosong' } } },
            };
