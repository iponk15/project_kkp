...
@section('content')
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <!--begin: Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom" id="ktTableRole"></div>
            <!--end: Datatable-->
        </div>
    </div>
    <!--begin::Modal-->
    ...
    <script>
        $(document).ready(function(){
            ...
            var column = [
                ...
                { field : 'role_nama', title : 'Nama' },
                { field : 'role_kode', title : 'Kode' },
                { field : 'role_deskripsi', title : 'Deskripsi'},
                ...
                { field : 'role_created_date', title : 'Created At', width : 170, textAlign : 'center' },
