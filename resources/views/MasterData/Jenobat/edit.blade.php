...
@section('content')
        ...
        <form class="form" id="jenobatFormEdit" method="POST" data-cofirm="1">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="jenobat_nama" placeholder="Masukan sekolah / universitas ..." autocomplete="off"/ value="{{ $records->jenobat_nama }}">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="jenobat_deskripsi" placeholder="Masukan jenjang ..." autocomplete="off" value="{{ $records->jenobat_deskripsi }}"/>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var fields = {
                jenobat_nama      : { validators : { notEmpty : { message : 'Nama tidak boleh kosong' } } },
                jenobat_deskripsi : { validators : { notEmpty : { message : 'De tidak boleh kosong' } } },
            };
