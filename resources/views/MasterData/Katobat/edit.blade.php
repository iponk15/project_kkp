...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="katobatFormEdit" method="POST" data-cofirm="1">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="katobat_nama" placeholder="Masukan sekolah / universitas ..." autocomplete="off"/ value="{{ $records->katobat_nama }}">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="katobat_deskripsi" placeholder="Masukan jenjang ..." autocomplete="off" value="{{ $records->katobat_deskripsi }}"/>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('katobatFormEdit');
            var urll   = "{{ route($route . '.update', ['id' => $id]) }}";
            var fields = {
                katobat_nama      : { validators : { notEmpty : { message : 'Nama tidak boleh kosong' } } },
                katobat_deskripsi : { validators : { notEmpty : { message : 'De tidak boleh kosong' } } },
            };
