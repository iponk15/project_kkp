...
@section('content')
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <!--begin: Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom"   id="ktTableKatobat"></div>
            <!--end: Datatable-->
        </div>
    </div>
    <!--begin::Modal-->
    ...
    <script>
        $(document).ready(function(){
            ...
            var column = [
                ...
                { field : 'katobat_nama', title : 'Nama' },
                { field : 'katobat_deskripsi', title : 'Deskripsi'},
                ...
                { field : 'katobat_created_date', title : 'Created At', width : 170, textAlign : 'center' },
