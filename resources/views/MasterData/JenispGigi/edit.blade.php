...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="poliFormEdit" method="POST" data-cofirm="1">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-form-label col-lg-3 col-sm-12 text-right">Warna <span class="text-danger"> * </span></label>
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="jenisp_warna" placeholder="Masukan kode ..." autocomplete="off"/ value="{{ $records->jenisp_warna }}">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="jenisp_nama" placeholder="Masukan nama ..." autocomplete="off"/ value="{{ $records->jenisp_nama }}">
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="jenisp_deskripsi" placeholder="Masukan deskripsi ..." autocomplete="off" value="{{ $records->jenisp_deskripsi }}"/>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('poliFormEdit');
            var urll   = "{{ route($route . '.update', ['id' => $id]) }}";
            var fields = {
                jenisp_nama      : { validators : { notEmpty : { message : 'Nama tidak boleh kosong' } } },
                jenisp_deskripsi : { validators : { notEmpty : { message : 'De tidak boleh kosong' } } },
            };
