...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="ukerFormEdit" method="POST" data-cofirm="1">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="uker_nama" placeholder="Masukan sekolah / universitas ..." autocomplete="off"/ value="{{ $records->uker_nama }}">
                        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('ukerFormEdit');
