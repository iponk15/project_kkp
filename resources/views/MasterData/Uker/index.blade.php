...
@section('content')
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <!--begin: Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom" id="ktTableUker"></div>
            <!--end: Datatable-->
        </div>
    </div>
    <!--begin::Modal-->
    ...
    <script>
        $(document).ready(function(){
            ...
            var column = [
                ...
                { field : 'uker_nama', title : 'Nama' },
                { field : 'uker_deskripsi', title : 'Deskripsi'},
                ...
                { field : 'uker_created_date', title : 'Created At', width : 170, textAlign : 'center' },
