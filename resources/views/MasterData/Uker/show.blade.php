...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="ukerFormTambah" method="POST">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="uker_nama" placeholder="Masukan nama ..." autocomplete="off"/>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <textarea name="uker_deskripsi" class="form-control" rows="3" placeholder="Masukan deskripsi ..."></textarea>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('ukerFormTambah');
            var urll   = "{{ route($route . '.store') }}";
            var fields = {
                uker_nama      : { validators : { notEmpty : { message : 'Nama tidak boleh kosong' } } },
                uker_deskripsi : { validators : { notEmpty : { message : 'De tidak boleh kosong' } } },
            };
