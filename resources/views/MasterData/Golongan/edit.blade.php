...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="golonganFormEdit" method="POST" data-cofirm="1">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="golongan_kode" placeholder="Masukan kode ..." autocomplete="off" value="{{ $records->golongan_kode }}" />
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="golongan_nama" placeholder="Masukan sekolah / universitas ..." autocomplete="off" value="{{ $records->golongan_nama }}" />
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="golongan_deskripsi" placeholder="Masukan jenjang ..." autocomplete="off" value="{{ $records->golongan_deskripsi }}"/>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('golonganFormEdit');
            var urll   = "{{ route($route . '.update', ['id' => $id]) }}";
            var fields = {
                golongan_kode      : { validators : { notEmpty : { message : 'Kode tidak boleh kosong' } } },
                golongan_nama      : { validators : { notEmpty : { message : 'Nama tidak boleh kosong' } } },
                golongan_deskripsi : { validators : { notEmpty : { message : 'De tidak boleh kosong' } } },
            };
