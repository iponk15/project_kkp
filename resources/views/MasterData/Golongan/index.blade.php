...
@section('content')
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <!--begin: Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom" id="ktTableGolongan"></div>
            <!--end: Datatable-->
        </div>
    </div>
    <!--begin::Modal-->
    ...
    <script>
        $(document).ready(function(){
            ...
            var column = [
                ...
                { field : 'golongan_kode', title : 'Kode', width : 40 },
                { field : 'golongan_nama', title : 'Nama' },
                { field : 'golongan_deskripsi', title : 'Deskripsi', width : 260 },
                ...
                { field : 'golongan_created_date', title : 'Created At', width : 170, textAlign : 'center' },
