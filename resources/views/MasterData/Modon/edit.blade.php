...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="modonFormEdit" method="POST" data-cofirm="1">
            {{ csrf_field() }}
            <div class="card-body">
                    ...
                    <div class="col-9 col-form-label">
                        <div class="radio-inline">
                            <label class="radio radio-primary">
                                <input type="radio" name="modon_tipe" value="1" {{ $records->modon_tipe == '1' ? 'checked' : '' }}>
                                <span></span>Box 5
                            </label>
                            <label class="radio radio-primary">
                                <input type="radio" name="modon_tipe" value="2" {{ $records->modon_tipe == '2' ? 'checked' : '' }}>
                                <span></span>Box 4
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="modon_kode" placeholder="Masukan kode ..." autocomplete="off" value="{{ $records->modon_kode }}"/>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="number" class="form-control" name="modon_no" placeholder="Masukan no ..." autocomplete="off" value="{{ $records->modon_no }}"/>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <textarea name="modon_transform" class="form-control" rows="3" placeholder="Masukan transform ...">{{ $records->modon_transform }}</textarea>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('modonFormEdit');
