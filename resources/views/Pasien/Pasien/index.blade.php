...
@section('content')
    <div class="card card-custom">
        ...
        <div class="card-body">
                    ...
                    <div class="col-lg-9 col-xl-8">
                        <form class="formSearch">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 my-2 my-md-0">
                                    <select class="form-control pasien_status" name="pasien_status">
            ...
            <!--begin: Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom" id="ktTablePasien"></div>
            <!--end: Datatable-->
        </div>
    </div>
    <!--begin::Modal-->
    ...
    <script>
        $(document).ready(function(){
            ...
            var column = [
                ...
                { field : 'pasien_norekdis', title : 'No. Rekamedis', width : 120 },
                ...
                { field : 'pasien_umur', title : 'Umur', textAlign : 'center', width : 40 },
                { field: 'status', title: 'Status', textAlign : 'center', sortable : false, 
                    ...
                    template: function(row) {
                        ...
                        return '<span class="label label-lg font-weight-bold' + status[row.pasien_status].class + ' label-inline">' + status[row.pasien_status].title + '</span>';
                    },
                },
                { field : 'pasien_created_date', title : 'Created At', width : 170, textAlign : 'center' },
