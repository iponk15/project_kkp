...
@section('content')
    <div class="d-flex flex-row">
        ...
        <div class="flex-row-auto offcanvas-mobile w-300px w-xl-350px" id="kt_profile_aside">
            ...
            <div class="card card-custom card-stretch">
                ...
                <div class="card-body pt-10">
                    ...
                    <!--begin::Nav-->
                    <div class="navi navi-bold navi-hover navi-link-rounded navi-active">
                        <div class="navi-item mb-2">
                            <a href="{{ route( 'pasieninfo.infoPeriksaSuster' ) }}" class="navi-link py-4 asideInfoCeklab active" data-toggle="tooltip" title="" data-placement="right" data-original-title="Hasil Pemeriksaan" data-transid="{{ $psntrans_id }}">
                        ...
                        <div class="navi-item mb-2">
                            <a href="{{ route( $route . '.showFormLab' ) }}" class="navi-link py-4 asideInfoCeklab" data-toggle="tooltip" title="" data-placement="right" data-original-title="Form Cek Lab" data-transid="{{ Hashids::encode($records->psnrekdis_id) }}">
                                <span class="navi-icon mr-2">
                                    <span class="svg-icon"><!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="navi-text font-size-lg"> Form Cek Lab </span>
                            </a>
                        </div>
                        
                        <div class="navi-item mb-2">
                            <a href="{{ route( 'pasieninfo.infoRekamedis' ) }}" class="navi-link py-4 asideInfoCeklab" data-toggle="tooltip" title="" data-placement="right" data-original-title="Riwayat Rekamedis" data-transid="{{ Hashids::encode($records->pasien_id) }}">
                                <span class="navi-icon mr-2">
        ...
        <!--begin::Content-->
        <div class="flex-row-fluid ml-lg-8 eleBlockUi" id="bodyCtnCekLab">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.asideInfoCeklab').on('click', function(e){
                ...
                $('.asideInfoCeklab').removeClass('active');
