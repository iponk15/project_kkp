                ...
                <div class="card-body pt-10">
                    ...
                    <div class="navi navi-bold navi-hover navi-link-rounded navi-active">
                        <div class="navi-item mb-2">
                            <a href="{{ route( $route . '.showFormLab' ) }}" class="navi-link py-4 asideInfoCeklab active" data-toggle="tooltip" title="" data-placement="right" data-original-title="Form Cek Lab" data-transid="{{ Hashids::encode($records->psnrekdis_id) }}">
                                ...
                                <span class="navi-text font-size-lg"> Cek Lab </span>
                            </a>
                        </div>
