<form method="POST" class="form" id="formRjkSps">
    {{ csrf_field() }}
            ...
            <div class="example-preview">
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <textarea name="rjksps_rs" class="form-control form-control-solid" rows="4" placeholder="Silahkan input RS / Jalan ..."></textarea>
                        <span class="form-text text-muted"></span>
                    </div>
                    <div class="col-lg-6">
                        <label>Keluhan / diagnosa sementara <span class="text-danger"> * </span></label>
                        <textarea name="rjksps_keluhan" class="form-control form-control-solid" rows="4" placeholder="Keluhan / diagnosa sementara ..."></textarea>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <textarea name="rjksps_ssb" class="form-control form-control-solid" rows="4" placeholder="Sudah saya berikan ..."></textarea>
                        <span class="form-text text-muted"></span>
                    </div>
                    <div class="col-lg-6">
                        <label>Keterangan lain</label>
                        <textarea name="rjksps_keterangan" class="form-control form-control-solid" rows="4" placeholder="Keterangan lain ..."></textarea>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-success font-weight-bold" id="btnResepObat">Simpan</button>
    </div>
</form>
...
<script>
    $(document).ready(function(){
        ...
        var form   = document.getElementById('formRjkSps');
        var urll   = "{{ route( $route . '.storeFormRjkSps', ['psnrekdis_id' => $psnrekdis_id] ) }}";
        var fields = {
