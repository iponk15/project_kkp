            ...
            <div class="card card-custom card-stretch">
                ...
                <div class="card-body pt-10">
                    ...
                    <div class="navi navi-bold navi-hover navi-link-rounded">
                        ...
                        <div class="navi-item mb-2">
                            <a href="{{ route( $route . '.infoRekamedis' ) }}" class="navi-link py-4 asideInfoPasien" data-toggle="tooltip" title="" data-placement="right" data-original-title="Riwayat Rekamedis" data-transid="{{ $psntrans_id }}">
                                <span class="navi-icon mr-2">
                                    <span class="svg-icon"><!--begin::Svg Icon | path:assets/media/svg/icons/Text/Article.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
